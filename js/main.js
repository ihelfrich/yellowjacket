...
const commandDefs = [
  ...
  { id: 'field-library', group: 'SOURCE', label: 'OPEN A FIELD RECORDING', note: 'Public-domain nature and city soundscapes, streamed from archive.org', keywords: 'nature birds ocean waves rain thunder storm crickets frogs city street soundscape field', button: 'btnField', run: () => ctx.api.revealFieldLibrary() },
