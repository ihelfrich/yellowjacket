...
const commandDefs = [
  ...
  { id: 'quick-take', group: 'SOURCE', label: 'QUICK TAKE · WEAVE THIS SOURCE', note: 'Cut four spans from the loaded recording, weave them onto the starter phrase, arm lane 9, and run', keywords: 'loom weave semantic take quick play instrument words chop', reason: 'LOAD AUDIO FIRST', enabled: () => !!store.runtime.buffer, run: () => ctx.api.quickTake() },
  { id: 'field-library', group: 'SOURCE', label: 'OPEN THE SHELF', note: 'Public-domain places, voices, scores, records, and oddities, streamed from archive.org', keywords: 'shelf field nature birds ocean waves rain thunder storm crickets frogs cicada city street soundscape voice speech poem hiawatha nasa voyager bach goldberg piano jazz blues 1921 kid ory ethel waters vlf magnetosphere whistler lossless flac 96k', button: 'btnField', run: () => ctx.api.revealFieldLibrary() },
