...
const PRECACHE = [
  ...
  'js/analysis/harmony.js',
  'js/analysis/cyclic.js',
  'js/compose/cyclic-score.js',
  'js/compose/cyclic-synth.js',
  'js/export/opz-project.js',
  'js/app/cyclic-controller.js',
  'js/score/model.js',
  'js/score/render.js',
  'js/app/confirm.js',
  'js/instrument/tuning.js',
  'js/instrument/from-source.js',
  'js/instrument/pool.js',
  ...
  'docs/lab/cards/fdr-vowel.json',
  'docs/lab/cards/hiawatha-vowel.json',
  ...
  'js/sigint/segment.js',
  'js/sigint/marker.js',
  'js/crypto/trigrams.js',
  'js/crypto/fitness.js',
  'js/crypto/classical.js',
  'js/crypto/enigma.js',
  'js/crypto/randomness.js',
  'js/sigint/classify.js',
  'js/sigint/tdoa.js',
  'js/sigint/decode/cw.js',
  'js/sigint/decode/fsk.js',
  'js/sigint/decode/rtty.js',
  'js/sigint/decode/tones.js',
  'js/sigint/decode/same.js',
  'js/sigint/decode/timecode.js',
  'js/sigint/decode/sstv.js',
  'js/sigint/decode/pager.js',
  'js/sigint/decode/ale.js',
  ...
  'js/render/peaks.js',
  'js/render/spectrogram-quant.js',
  './',
  './index.html',
  './css/yj.css',
