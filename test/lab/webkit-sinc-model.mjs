...
const K = 32, PH = 32, SCALE_ADJ = 0.90;
...
for (const f of [1000, 10000, 19000, 20000, 21000, 22000, 23000, 23500]) run(f, 48000, 96000, 'webkit32 48k->96k');
for (const f of [1000, 15000, 19000, 20000, 21000]) run(f, 44100, 96000, 'webkit32 44.1k->96k');
